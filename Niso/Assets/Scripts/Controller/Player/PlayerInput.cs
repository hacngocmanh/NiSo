...
public partial class PlayerInput : MonoBehaviour
{
    ...
    public float verticalDPadThreshold = .5f;       //Threshold touch pad input
                                                    //Reference to jump TouchButton

    [HideInInspector] public float horizontal;      //Float that stores horizontal input
    [HideInInspector] public bool dashPressed;         //Bool that stores jump pressed
    ...
    [HideInInspector] public bool keyW;
    ...
    void ProcessInputs()
    {
        ...
        attackPressed = attackPressed || Input.GetMouseButtonDown(0);
        keyW = keyW || Input.GetKey(KeyCode.W);
